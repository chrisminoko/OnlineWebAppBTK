...
namespace OnlineWebApp.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Brand_Id,Tag_Name")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Brand_Id,Tag_Name")] Brand brand)
        {
            if (ModelState.IsValid)
            {
